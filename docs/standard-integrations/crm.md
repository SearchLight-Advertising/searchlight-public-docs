...
This document defines the schema and bucket structure for CRM integrations with SearchLight. For S3 setup, file format, and access steps see the [overview](./overview).
...
| `updated_date` | string (ISO 8601) | required | Date/time the customer record was last updated | `"2026-02-10T14:00:00Z"` |
...
| `updated_date` | string (ISO 8601) | required | Date/time the estimate was last updated | `"2026-03-15T09:00:00Z"` |
| `total` | number | required | Estimated dollar value of the job | `1850.00` |
| `status` | string | required | Current status of the estimate (e.g. Accepted, Rejected). | `"Accepted"` |
...
| `technician` | string | optional | Name of the assigned technician or sales rep | `"Jane Doe"` |
...
| `updated_date` | string (ISO 8601) | required | Date/time the job was last updated | `"2026-03-15T09:00:00Z"` |
